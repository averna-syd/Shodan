...
See L<Shodan::API::REST|https://github.com/averna-syd/Shodan/blob/main/README_REST_API.md> readme for more information.
...
See L<Shodan::API::Exploit|https://github.com/averna-syd/Shodan/blob/main/README_EXPLOIT_API.md> readme for more information.
...
See L<Shodan::API::Stream|https://github.com/averna-syd/Shodan/blob/main/README_STREAM_API.md> readme for more information.

=head2 DISCLAIMER

This is an early version thus methods maybe subject to change.
The author does not have access to an enterprise account.
Therefore while ever effort was made to ensure enterprise method calls are correct,
without adequate testing of enterprise calls the author can not be as confident
when compared to method calls which can be adequately tested.
